...
export const getEmployeeList = (params?: any): Promise<ApiResponse<EmployeeItemResponse[]>> => {
  ...
  return request.get<ApiResponse<EmployeeItemResponse[]>>('api/employee/list', { params }).then(response => response.data) // Added api/
    .catch(error => {
...
export const getEmployeeDetail = (id: number): Promise<ApiResponse<EmployeeItemResponse>> => {
  ...
  return request.get<ApiResponse<EmployeeItemResponse>>(`api/employee/${id}`).then(response => response.data) // Added api/
    .catch(error => {
...
export const addEmployee = (data: EmployeeFormData): Promise<ApiResponse<EmployeeItemResponse>> => {
  ...
  return request.post<ApiResponse<EmployeeItemResponse>>('api/employee/add', data).then(response => response.data) // Added api/
    .catch(error => {
...
export const updateEmployee = (id: number, data: EmployeeFormData): Promise<ApiResponse<EmployeeItemResponse>> => {
  ...
  return request.put<ApiResponse<EmployeeItemResponse>>(`api/employee/${id}`, data).then(response => response.data) // Added api/
    .catch(error => {
...
export const deleteEmployee = (id: number): Promise<ApiResponse<void>> => {
  ...
  return request.delete<ApiResponse<void>>(`api/employee/${id}`).then(response => response.data) // Added api/
    .catch(error => {
...
export const batchDeleteEmployee = (ids: number[]): Promise<ApiResponse<void>> => {
  ...
  return request.delete<ApiResponse<void>>('api/employee/batch', { data: { ids } }).then(response => response.data) // Added api/
    .catch(error => {
...
export const getEmployeeStats = (): Promise<ApiResponse<any>> => {
  ...
  return request.get<ApiResponse<any>>('api/employee/stats').then(response => response.data) // Added api/
    .catch(error => {
...
export const getDeptList = () => {
  ...
  return request.get<ApiResponse<DeptResponseData[]>>('api/dept/list').then(response => response.data) // Assuming dept list is also under /api/dept. Added api/
}

// 添加部门检查
export const checkDepartment = (id: number) => {
  console.log('调用checkDepartment API, ID:', id);
  return request.get<ApiResponse<boolean>>(`api/employee/checkDept/${id}`).then(response => response.data) // Added api/
}