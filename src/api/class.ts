...
export const getClassList = (params?: any): Promise<ApiResponse<ClassItemResponse[]>> => {
  ...
  return request.get<ApiResponse<ClassItemResponse[]>>('api/class/list', { params }).then(response => response.data)
    .catch(error => {
...
export const getClassDetail = (id: number): Promise<ApiResponse<ClassItemResponse>> => {
  ...
  return request.get<ApiResponse<ClassItemResponse>>(`api/class/${id}`).then(response => response.data)
    .catch(error => {
...
export const addClass = (data: ClassItem): Promise<ApiResponse<ClassItemResponse>> => {
  ...
  return request.post<ApiResponse<ClassItemResponse>>('api/class/add', data).then(response => response.data)
    .catch(error => {
...
export const updateClass = (id: number, data: ClassItem): Promise<ApiResponse<ClassItemResponse>> => {
  ...
  return request.put<ApiResponse<ClassItemResponse>>(`api/class/update`, data).then(response => response.data) // Note: Backend update might be api/class/{id} or api/class/update
    .catch(error => {
...
export const deleteClass = (id: number): Promise<ApiResponse<void>> => {
  ...
  return request.delete<ApiResponse<void>>(`api/class/delete/${id}`).then(response => response.data)
    .catch(error => {
...
export function batchDeleteClass(ids: number[]) {
  ...
  return request.delete<ApiResponse<void>>('api/class/batch', { data: { ids } }).then(response => response.data)
}

// 获取班级统计数据
export function getClassStats() {
  console.log('调用getClassStats API');
  return request.get<ApiResponse<any>>('api/class/stats').then(response => response.data)
}
...
export const getClassOptions = (): Promise<ApiResponse<ClassItem[]>> => {
    ...
    return request.get<ApiResponse<ClassItem[]>>('api/class/options').then(response => response.data)
      .catch(error => {
